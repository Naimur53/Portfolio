        ...
        <section>
            ...
            <div className="container py-sm-5 py-md-5 mb-5">
                <div className=" cursor-full showcase-main-wrap">
                    ...
                    <div className="cursor-full showcase-item-container " data-aos="fade-up">
                    ...
                    <div className="cursor-full showcase-item-container" data-aos="fade-up">
                        <div className="h-100 showcase-item-wrap showcase-item-wrap-height-2x">
                            <a className="h-100 d-inline-block d-flex flex-column justify-content-between text-white"
                                target="_blank" rel="noreferrer" href="https://github.com/Naimur53/presento">
                                <div className="h-100 showcase-img-wrap show-1 showcase-img-wrap-height-2x">
                                </div>
                                <h5 className="text-center pt-4">Presento websites</h5>
                            </a>
                        </div>
                    </div>
                    ...
                    <div className="cursor-full showcase-item-container" data-aos="fade-up">
                        <div className="h-100 showcase-item-wrap showcase-item-wrap-height-2x">
                            <a className="h-100 d-inline-block d-flex flex-column justify-content-between text-white"
                                target="_blank" rel="noreferrer" href="https://github.com/Naimur53/monu">
                                <div className="h-100 showcase-img-wrap show-2 showcase-img-wrap-height-2x">
                                </div>
                                <h5 className="text-center pt-4">Monu websites</h5>
                            </a>
                        </div>
                    </div>
                    <div className="cursor-full showcase-item-container" data-aos="fade-up">
                        <div className="h-100 showcase-item-wrap showcase-item-wrap-height-2x">
                            <a className="h-100 d-inline-block d-flex flex-column justify-content-between text-white"
                                target="_blank" rel="noreferrer" href="https://github.com/Naimur53/bemax">
                                <div className="h-100 showcase-img-wrap show-3 showcase-img-wrap-height-2x">
                                </div>
                                <h5 className="text-center pt-4">Bemax websites</h5>
                            </a>
                        </div>
                    </div>
                    <div className="cursor-full showcase-item-container" data-aos="fade-up">
                        <div className="h-100 showcase-item-wrap showcase-item-wrap-height-2x">
                            <a className="h-100 d-inline-block d-flex flex-column justify-content-between text-white" rel="noreferrer"
                                target="_blank" href="https://github.com/Naimur53/Hello-second-project">
                                <div className="h-100 showcase-img-wrap show-4 showcase-img-wrap-height-2x">
                                </div>
                                <h5 className="text-center pt-4">Artistika websites</h5>
                            </a>
                        </div>
                    </div>
                    <div className="cursor-full showcase-item-container" data-aos="fade-up">
